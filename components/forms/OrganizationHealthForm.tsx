// components/forms/OrganizationHealthForm.tsx
"use client";
...
const INDICATORS = [
  ...
  { id: "coordinationControl", label: "Coordination & Control" },
  { id: "leadership", label: "Leadership" },
  { id: "innovationLearning", label: "Innovation & Learning" },
  { id: "externalOrientation", label: "External Orientation" },
  { id: "direction", label: "Direction" },
  { id: "capabilities", label: "Capabilities" },
  { id: "workEnvironment", label: "Work Environment" },
  { id: "totalScore", label: "Skor Total" },
];
...
export const OrganizationHealthForm: React.FC<FormProps> = ({ companies }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setMessage("");
    try {
      const res = await fetch("/api/input/organization-health", {
        method: "POST",
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          {isLoading ? "Menyimpan..." : "Simpan Data Organization Health"}
        </button>
      </div>
      {message && (
        <p
...
export default OrganizationHealthForm;
