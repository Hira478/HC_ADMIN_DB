// components/forms/EmployeeEngagementForm.tsx
"use client";
...
const INDICATORS = [
  { id: "say", label: "Say" },
  { id: "stay", label: "Stay" },
  { id: "strive", label: "Strive" },
  { id: "totalScore", label: "Skor Total Engagement" },
];
...
const EmployeeEngagementForm: React.FC<FormProps> = ({ companies }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setMessage("");
    try {
      const res = await fetch("/api/input/employee-engagement", {
        method: "POST",
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          {isLoading ? "Menyimpan..." : "Simpan Data Engagement"}
        </button>
      </div>
      {message && (
        <p
